...
from pushapp.models import GCMDevice, APNSDevice
...
class ModelTestCase(TestCase):
    ...
    def test_gcm_send_message(self):
        ...
        with mock.patch("pushapp.gcm._gcm_send", return_value=GCM_PLAIN_RESPONSE) as p:
    ...
    def test_gcm_send_message_to_multiple_devices(self):
        ...
        with mock.patch("pushapp.gcm._gcm_send", return_value=GCM_MULTIPLE_JSON_RESPONSE) as p:
    ...
    def test_apns_send_message(self):
        ...
        with mock.patch("pushapp.apns._apns_pack_frame") as p:
